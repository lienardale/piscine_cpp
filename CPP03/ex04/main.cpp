...
int main()
{
	...
	std::cout << "HP -> 100 | " << SUPER_T0.get_hit_points() << std::endl;
	std::cout << "EP -> 120 | " << SUPER_T0.get_energy_points() << std::endl;
	std::cout << "MA -> 60  | " << SUPER_T0.get_melee_attack_damage() << std::endl;
	std::cout << "RA -> 20  | " << SUPER_T0.get_range_attack_damage() << std::endl;
	std::cout << "AD -> 5   | " << SUPER_T0.get_armor_damage_reduction() << std::endl;
	std::cout << std::endl;
	std::cout << "HP -> 100 | " << SUPER_T1.get_hit_points() << std::endl;
	std::cout << "EP -> 120 | " << SUPER_T1.get_energy_points() << std::endl;
	std::cout << "MA -> 60  | " << SUPER_T1.get_melee_attack_damage() << std::endl;
	std::cout << "RA -> 20  | " << SUPER_T1.get_range_attack_damage() << std::endl;
