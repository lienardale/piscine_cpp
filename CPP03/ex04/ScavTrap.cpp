...
/*   Updated: 2021/02/22 13:58:16 by alienard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(const ScavTrap& obj) : ClapTrap(obj._hit_points, obj._max_hit_points, obj._energy_points, obj._max_energy_points, obj._level, obj._name, obj._melee_attack_damage, obj._range_attack_damage, obj._armor_damage_reduction, obj._type)
{
	// *this = obj;
	if (PRINT)
