...
/*   Updated: 2021/02/19 20:21:39 by alienard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap&	ScavTrap::operator=(const ScavTrap& obj)
{
	...
	if (PRINT)
		std::cout << "SC4V-TP Assignation Operator called. "<< this->_name << " : Séquence d'initiation terminée. Bonjour, je suis votre nouveau robot multifonction." << std::endl;
	return *this;
}
